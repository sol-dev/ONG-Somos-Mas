...
public class ConstantSwaggerMessage {
    public static final String MSG_TESTIMONIALDTO_NAME_VALUE = "The testimonial's name";
    public static final String MSG_TESTIMONIALDTO_NAME_EXAMPLE = "Testimonio";
    public static final String MSG_TESTIMONIALDTO_IMAGE_VALUE = "The testimonial's image";
    public static final String MSG_TESTIMONIALDTO_CONTENT_VALUE = "The testimonial's content";
    public static final String MSG_TESTIMONIALDTO_CONTENT_EXAMPLE = "Contenido";
    ...
    public static final String MSG_TESTIMONIAL_CONTROLLER_APIOPERATION_DELETE_NOTE= "Delete a testimonial by Id";
}
